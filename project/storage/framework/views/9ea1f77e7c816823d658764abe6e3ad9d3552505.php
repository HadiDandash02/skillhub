...
<?php $__env->startSection('title', $course->title . ' - SkillHub Professional Learning'); ?>
<?php $__env->startSection('description', 'Master ' . $course->title . ' with our comprehensive learning experience featuring interactive materials, assessments, and expert guidance.'); ?>
...
<div class="course-page">
    ...
    <section class="hero-section">
        <div class="hero-container">
            ...
            <p class="hero-description"><?php echo e($course->description); ?></p>
            
            <div class="hero-stats">
                <div class="stat-item">
                    <span class="stat-number"><?php echo e($course->chapters->count()); ?></span>
                    <span class="stat-label">Chapters</span>
                </div>
                <div class="stat-item">
                    <span class="stat-number"><?php echo e($course->quizzes->count()); ?></span>
                    <span class="stat-label">Quizzes</span>
                </div>
                <div class="stat-item">
                    <span class="stat-number"><?php echo e($course->challenges->count()); ?></span>
                ...
                <div class="stat-item rating-stat">
                    <div class="stat-rating-display">
                        <div class="star-rating-hero" id="hero-star-rating-<?php echo e($course->id); ?>">
                            <?php
                        ...
                        <span class="stat-number rating-number" id="hero-rating-number-<?php echo e($course->id); ?>"><?php echo e(number_format($course->averageRating(), 1)); ?></span>
                    </div>
                ...
                <div class="stat-item rate-action">
                    <button class="btn-rate-hero rate-toggle" data-course="<?php echo e($course->id); ?>">
                        <div class="btn-icon">
                        ...
                        <span class="btn-text">
                            <?php
                                $userRating = \App\Models\Rating::where('course_id', $course->id)
                                                ...
                                                ->first();
                            ?>
                            <?php echo e($userRating ? 'Update Rating' : 'Rate Course'); ?>

                        </span>
                    </button>
                    <span class="stat-label">
                        <?php if($userRating): ?>
                            Your Rating: <?php echo e($userRating->rating); ?>/5
                        <?php else: ?>
                ...
                <div class="stat-item guest-action">
                    <a href="<?php echo e(route('login')); ?>" class="btn-rate-hero guest-login">
                        <div class="btn-icon">
    ...
    <?php if(auth()->guard()->check()): ?>
    <div class="rating-overlay hidden" id="rating-overlay-<?php echo e($course->id); ?>">
        <div class="rating-popup hero-rating-popup">
            <span class="close-rating" data-course="<?php echo e($course->id); ?>">&times;</span>
            <form action="<?php echo e(route('ratings.store', $course->id)); ?>" method="POST" class="rating-form hero-rating-form">
                <?php echo csrf_field(); ?>
                <div class="popup-header">
                    <div class="popup-icon">
                        <i class="fas fa-star"></i>
                    </div>
                    <h3 class="rating-title">Rate "<?php echo e($course->title); ?>"</h3>
                    <p class="rating-subtitle">Help other learners by sharing your experience</p>
                </div>
                
                <div class="rating-stars">
                    <?php for($i = 5; $i >= 1; $i--): ?>
                        <input type="radio" id="hero-star<?php echo e($i); ?>-<?php echo e($course->id); ?>" name="rating" value="<?php echo e($i); ?>" required>
                        <label for="hero-star<?php echo e($i); ?>-<?php echo e($course->id); ?>" class="star">★</label>
                    <?php endfor; ?>
                </div>
    ...
    <div class="content-wrapper">
        <div class="content-container">
                ...
                <div id="chapters" class="section-content">
                    <div class="chapter-list">
                        ...
                        <div class="chapter-item">
                            <button class="chapter-header" onclick="toggleChapterDetails(<?php echo e($chapter->id); ?>)">
                                <div class="chapter-title">
                                    <div class="chapter-number"><?php echo e($loop->iteration); ?></div>
                                    <span><?php echo e($chapter->title); ?></span>
                                </div>
                                <div class="toggle-indicator" id="chapter-icon-<?php echo e($chapter->id); ?>">+</div>
                            </button>
                            
                            <div id="chapter-details-<?php echo e($chapter->id); ?>" class="chapter-content">
                                ...
                                <div class="resources-grid">
                                    ...
                                    <div class="resource-card">
                                        ...
                                        <a href="<?php echo e(asset('storage/pdfs/' . $pdf->pdf_path)); ?>" target="_blank" class="resource-action">
                    ...
                    <div class="activities-grid">
                        ...
                        <div class="activity-card quiz">
                            ...
                            <div class="activity-body">
                                <h3 class="activity-title"><?php echo e($quiz->title); ?></h3>
                                <p class="activity-description"><?php echo e($quiz->description); ?></p>
                                ...
                                <a href="<?php echo e(route('quiz.show', $quiz->id)); ?>" class="resource-action">
                ...
                <div id="challenges" class="section-content">
                    <div class="activities-grid">
                        ...
                        <div class="activity-card">
                            ...
                            <div class="activity-body">
                                <h3 class="activity-title"><?php echo e($challenge->title); ?></h3>
                                <p class="activity-description"><?php echo e($challenge->description); ?></p>
                                <div class="activity-meta">
                                    <div class="meta-item">
                                ...
                                <a href="<?php echo e(route('challenge.show', $challenge->id)); ?>" class="resource-action">
                ...
                <div id="tutorials" class="section-content">
                    ...
                    <div class="video-section">
                        ...
                        <?php else: ?>
                         <div class="video-container" style="display: flex; align-items: center; justify-content: center; background: #f8fafc; min-height: 300px;">
                            <div style="text-align: center;">
                                ...
                                <a href="<?php echo e($tutorialLink); ?>" target="_blank" class="resource-action">
                                    <i class="fas fa-external-link-alt"></i>
                                    Open Content
                                </a>
                            </div>
                        ...
                        <div class="video-footer">
                            <a href="<?php echo e($tutorialLink); ?>" target="_blank" class="external-link">
                                <i class="fas fa-external-link-alt"></i>
            ...
            <div class="navigation-section">
                ...
                <a href="<?php echo e(route($route)); ?>" class="back-button">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/courses/show.blade.php ENDPATH**/ ?>