        ...
        <div class="advice-header-container">
            <div class="header-content">
                ...
                <div class="header-stats">
                    <div class="stat-item">
                        <i class="fas fa-lightbulb"></i>
                        <span><?php echo e(count($advices)); ?> Total Articles</span>
                    </div>
                    <div class="stat-item">
        ...
        <div class="advice-content-container">
            ...
            <div class="management-controls">
                ...
                <div class="quick-actions-section">
                    <div class="action-card primary-action">
                        ...
                        <a href="<?php echo e(route('careerM.career-advice.create')); ?>" class="action-button">
            ...
            <div class="table-card">
                    ...
                    <div class="table-actions">
                        <div class="advice-stats">
                            ...
                            <div class="stat-badge">
                                ...
                                <span><?php echo e($categories); ?> Categories</span>
                            </div>
                            <div class="stat-badge">
                                <i class="fas fa-file-alt"></i>
                                <span><?php echo e(number_format($totalWords)); ?> Words</span>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr class="advice-row">
                                            ...
                                            <div class="advice-info">
                                                ...
                                                <div class="advice-details">
                                                    ...
                                                    <p class="advice-meta">
                                                        ...
                                                        <?php echo e($advice->author ?? 'System Career Manager'); ?>
                                        ...
                                        <td class="category-cell">
                                            <span class="category-badge">
                                                <i class="fas fa-tag"></i>
                                                <?php echo e($advice->category ?? 'General'); ?>

                                            </span>
                                        </td>
                                        <td class="preview-cell">
                                            <div class="content-preview">
                                                <p class="preview-text"><?php echo e(Str::limit(strip_tags($advice->content ?? ''), 80)); ?></p>
                                                <div class="content-stats">
                                                    <span class="word-count">
                                                        <i class="fas fa-file-word"></i>
                                                        <?php echo e(str_word_count(strip_tags($advice->content ?? ''))); ?> words
                                                    </span>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="actions-cell">
                                            <div class="action-buttons">
                                                <a href="<?php echo e(route('careerM.career-advice.edit', $advice->id)); ?>" class="btn btn-edit" title="Edit Advice">
                                                    <i class="fas fa-edit"></i>
                                                    <span>Edit</span>
                                                </a>
                                                <a href="<?php echo e(route('careerAdvice.show', $advice->id)); ?>" class="btn btn-view" title="View Advice">
                                                    <i class="fas fa-eye"></i>
                                                    <span>View</span>
                                                </a>
                                                <form action="<?php echo e(route('careerM.career-advice.destroy', $advice->id)); ?>" method="POST" class="delete-form">
                                                    <?php echo csrf_field(); ?>
                ...
                <div class="empty-state">
                    ...
                    <a href="<?php echo e(route('careerM.career-advice.create')); ?>" class="btn-empty-action">
                        <i class="fas fa-plus"></i>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('🚀 Professional Career Manager Advice Management with Scrollable Table loaded successfully!');
});
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/careerManager/advices/index.blade.php ENDPATH**/ ?>