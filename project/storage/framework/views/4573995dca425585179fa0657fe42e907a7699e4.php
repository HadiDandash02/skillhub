...
<div class="course-page">
    ...
    <div class="content-wrapper">
        <div class="content-container">
            <form method="POST" action="<?php echo e(route('instructor.courses.store')); ?>" class="edit-course-form" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" name="instructor" value="<?php echo e(auth()->user()->name); ?>">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/instructor/courses/create.blade.php ENDPATH**/ ?>