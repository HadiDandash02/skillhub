                        ...
                        <tbody>
                            ...
                            <tr class="application-row" data-status="<?php echo e(strtolower($application->status)); ?>">
                                ...
                                <td class="actions-cell">
                                    <form action="<?php echo e(route('admin.applications.update', $application->id)); ?>" method="POST" class="status-form">
                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/admin/applications.blade.php ENDPATH**/ ?>