...
<?php $__env->startSection('title', 'Challenge: ' . $challenge->title . ' - SkillHub'); ?>
    ...
    <section class="hero-section">
        <div class="hero-container">
            <div class="challenge-badge">
                ...
                <span><?php echo e(ucfirst($challenge->language_name)); ?> Challenge</span>
            </div>
            ...
            <p class="hero-description">
                Solve this <?php echo e($challenge->language_name); ?> programming challenge
            </p>
            
            <div class="hero-stats">
                <div class="stat-item">
                    <span class="stat-number"><?php echo e(ucfirst($challenge->language_name)); ?></span>
                    <span class="stat-label">Language</span>
                </div>
                <div class="stat-item">
                    <span class="stat-number"><?php echo e(ucfirst($challenge->difficulty ?? 'Medium')); ?></span>
                    <span class="stat-label">Difficulty</span>
                </div>
                <div class="stat-item">
                    <span class="stat-number"><?php echo e($challenge->attempts ?? 0); ?></span>
                    <span class="stat-label">Attempts</span>
                </div>
                <div class="stat-item">
                    <span class="stat-number"><?php echo e($challenge->success_rate ?? 0); ?>%</span>
                ...
                <div class="section-content">
                    ...
                    <div class="instructions-card">
                        ...
                        <div class="instructions-text">
                            <?php echo e($challenge->instructions ?? 'No specific instructions provided for this challenge.'); ?>
                    ...
                    <div class="expected-output-card">
                        ...
                        <div class="expected-output-text"><?php echo e($challenge->expected_output ?? 'No expected output provided.'); ?></div>
                    </div>

                    <?php if($challenge->testCases && $challenge->testCases->count() > 0): ?>
                    <div class="test-cases-preview">
                        <h4>
                            <i class="fas fa-flask"></i>
                            Sample Test Cases
                        </h4>
                        <?php $__currentLoopData = $challenge->testCases->take(2); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $testCase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="test-case-item">
                            <div class="test-case-header">Test Case <?php echo e($index + 1); ?></div>
                            <div class="test-case-details">
                                <?php if($testCase->input): ?>
                                <div><strong>Input:</strong> <code><?php echo e($testCase->input); ?></code></div>
                                <?php endif; ?>
                                <div><strong>Expected Output:</strong> <code><?php echo e($testCase->expected_output); ?></code></div>
                                <?php if($testCase->description): ?>
                                <div><strong>Description:</strong> <?php echo e($testCase->description); ?></div>
                                <?php endif; ?>
                            </div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if($challenge->testCases->count() > 2): ?>
                        <p style="margin-top: 1rem; font-size: 0.875rem; color: #6b7280; text-align: center;">
                            <i class="fas fa-info-circle"></i>
                            <?php echo e($challenge->testCases->count() - 2); ?> more test cases will be used for evaluation
                        </p>
                        <?php endif; ?>
                    </div>
                    <?php endif; ?>
                        ...
                        <div class="test-case-item">
                            <div class="test-case-details">
                                <div><strong>Status:</strong> 
                                    <span class="status-indicator status-<?php echo e($latestSubmission->status); ?>">
                                        <i class="fas fa-<?php echo e($latestSubmission->status === 'passed' ? 'check' : 'times'); ?>"></i>
                                        <?php echo e(ucfirst($latestSubmission->status)); ?>

                                    </span>
                                </div>
                                <div><strong>Score:</strong> <?php echo e($latestSubmission->score); ?>%</div>
                                <div><strong>Tests Passed:</strong> <?php echo e($latestSubmission->passed_tests_count); ?>/<?php echo e($latestSubmission->total_tests_count); ?></div>
                                <div><strong>Submitted:</strong> <?php echo e($latestSubmission->submitted_at->diffForHumans()); ?></div>
                            </div>
                        </div>
                    </div>
                    <?php endif; ?>
            ...
            <div class="challenge-editor-section">
                <div class="section-header">
                    <div class="section-title">
                        ...
                        <span><?php echo e(ucfirst($challenge->language_name)); ?> Code Editor</span>
                    </div>
                </div>
                ...
                <div class="section-content">
                    <div class="language-info">
                        <div class="language-badge">
                            <i class="fas fa-code"></i>
                            <span><?php echo e(ucfirst($challenge->language_name)); ?> Only</span>
                        </div>
                        <div class="challenge-info">
                            This challenge must be solved in <?php echo e(ucfirst($challenge->language_name)); ?>
                    ...
                    <div class="code-editor-container">
                        <div class="editor-toolbar">
                            <div class="editor-title">
                                ...
                                <span><?php echo e(ucfirst($challenge->language_name)); ?> Solution</span>
                            </div>
                        ...
                        <textarea 
                            id="codeEditor" 
                            class="code-editor" 
                            placeholder="<?php echo e($challenge->code_placeholder ?? '// Write your ' . $challenge->language_name . ' solution here...'); ?>"
                            disabled
                        ><?php echo e($latestSubmission ? $latestSubmission->code : ($challenge->code_placeholder ?? '')); ?></textarea>
                    </div>

                    <div class="editor-features">
                        <div class="feature-badge">
                            <i class="fas fa-code"></i>
                            <span><?php echo e(ucfirst($challenge->language_name)); ?></span>
                        </div>
                        <div class="feature-badge">
                    ...
                    <div class="challenge-controls">
                        ...
                        <div class="challenge-actions">
                            ...
                            <button class="btn btn-success" id="SubmitChallenge" style="display: none;" disabled>
                                ...
                                <span>Submit <?php echo e(ucfirst($challenge->language_name)); ?> Solution</span>
                            </button>
                        </div>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const challengeLanguage = '<?php echo e($challenge->language_name); ?>';

    function startChallenge() {
        console.log('Starting <?php echo e($challenge->language_name); ?> challenge...');
        ...
        showNotification(`<?php echo e(ucfirst($challenge->language_name)); ?> challenge started!`, 'success');
        codeEditor.focus();
    }
    ...
    function submitChallenge() {
        ...
        if (!code) {
            showNotification('Please write some <?php echo e($challenge->language_name); ?> code before submitting!', 'error');
            return;
        }
        ...
        // Update UI
        submitButton.innerHTML = '<i class="fas fa-spinner fa-spin"></i><span>Evaluating <?php echo e(ucfirst($challenge->language_name)); ?>...</span>';
        ...
        // Submit to backend
        fetch(`/challenge/<?php echo e($challenge->id); ?>/submit`, {
            method: 'POST',
            headers: {
        ...
        .catch(error => {
            ...
            // Reset button
            submitButton.innerHTML = '<i class="fas fa-check"></i><span>Submit <?php echo e(ucfirst($challenge->language_name)); ?> Solution</span>';
    ...
    function handleSuccessfulSubmission(data) {
        showNotification(`🎉 Congratulations! All tests passed in <?php echo e($challenge->language_name); ?>!`, 'success');
        
        // Disable further submissions
        submitButton.innerHTML = '<i class="fas fa-trophy"></i><span><?php echo e(ucfirst($challenge->language_name)); ?> Challenge Completed</span>';
        submitButton.disabled = true;
    ...
    function showLoadingOverlay() {
        ...
        overlay.innerHTML = `
            <div class="loading-content">
                ...
                <h3>Evaluating <?php echo e(ucfirst($challenge->language_name)); ?> Code...</h3>
                <p>Running test cases and checking your solution</p>
                <div class="loading-steps">
                    <div class="step active">Compiling <?php echo e($challenge->language_name); ?> code...</div>
            ...
            <div class="results-modal">
                <div class="results-header">
                    <h3>
                        ...
                        <?php echo e(ucfirst($challenge->language_name)); ?> Submission Results
                    </h3>
                ...
                <div class="results-summary">
                    <div class="result-stat">
                        <span class="stat-label">Language:</span>
                        <span class="stat-value"><?php echo e(ucfirst($challenge->language_name)); ?></span>
                    </div>
                    <div class="result-stat">
    ...
    function showCelebration(celebrationData) {
        ...
        celebration.innerHTML = `
            <div class="celebration-content">
                ...
                <h2>🎉 <?php echo e(ucfirst($challenge->language_name)); ?> Challenge Completed!</h2>
    ...
    function autoSave() {
        ...
        localStorage.setItem('challenge_code_<?php echo e($challenge->id); ?>', code);
        console.log('<?php echo e(ucfirst($challenge->language_name)); ?> code auto-saved');
    }

    function loadSavedCode() {
        if (!codeEditor.value.trim()) {
            const savedCode = localStorage.getItem('challenge_code_<?php echo e($challenge->id); ?>');
            if (savedCode) {
                codeEditor.value = savedCode;
                console.log('Loaded saved <?php echo e($challenge->language_name); ?> code');
            }
        }
    }
    ...
    formatCodeBtn.addEventListener('click', function() {
        ...
        showNotification('<?php echo e(ucfirst($challenge->language_name)); ?> code formatted!', 'success');
    });

    // Reset code button
    resetCodeBtn.addEventListener('click', function() {
        if (confirm('Are you sure you want to reset your <?php echo e($challenge->language_name); ?> code? This cannot be undone.')) {
            codeEditor.value = `<?php echo e(addslashes($challenge->code_placeholder ?? '')); ?>`;
    ...
    function handleKeyboardShortcuts(e) {
        ...
        if ((e.ctrlKey || e.metaKey) && e.key === 's') {
            e.preventDefault();
            autoSave();
            showNotification('<?php echo e(ucfirst($challenge->language_name)); ?> code saved! 💾', 'success');
        }
    }
    ...
    window.addEventListener('beforeunload', function(e) {
        if (isStarted && !isPaused && seconds > 30) {
            e.preventDefault();
            e.returnValue = 'You have an active <?php echo e($challenge->language_name); ?> challenge. Are you sure you want to leave?';
            return e.returnValue;
        }
    });

    console.log('<?php echo e(ucfirst($challenge->language_name)); ?> challenge page initialized successfully! 🚀');
});
</script>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/challenge/show.blade.php ENDPATH**/ ?>