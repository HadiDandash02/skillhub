...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group">
                                ...
                                <div class="company-field-wrapper">
                                    <input type="text" id="company_name" name="company_name" 
                                           ...
                                           value="<?php echo e($user->company_name ?? 'Not Assigned'); ?>" 
                                           readonly disabled>
            ...
            <div class="profile-card">
                ...
                <div class="card-body">
                    <form method="post" action="<?php echo e(route('password.update')); ?>" class="password-form">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/profile/edit.blade.php ENDPATH**/ ?>