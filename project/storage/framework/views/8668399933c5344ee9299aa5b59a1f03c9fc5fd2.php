        ...
        <div class="users-content-container">
            ...
            <div class="management-controls">
                ...
                <div class="filter-section">
                    <form method="GET" action="<?php echo e(route('admin.users')); ?>" class="role-filter-form">
                        <div class="role-filter-container">
                            <div class="filter-input-wrapper">
                                ...
                                <select name="role" class="role-select">
                                    ...
                                    <option value="careerM" <?php echo e(request('role') == 'careerM' ? 'selected' : ''); ?>>Career Manager</option>
            ...
            <div class="table-card">
                <div class="table-header">
                    ...
                    <div class="table-actions">
                        <button type="button" class="btn btn-create" onclick="window.location.href='<?php echo e(route('admin.createUser')); ?>'">
                            <i class="fas fa-plus"></i>
                            <span>Create User</span>
                        </button>
                        <span class="user-count">
                            <i class="fas fa-info-circle"></i>
                            Total: <?php echo e($users->count()); ?> users
                                    ...
                                    <tr class="user-row">
                                        ...
                                        <td class="actions-cell">
                                            <div class="action-buttons">
                                                <button type="button" class="btn btn-edit" onclick="window.location.href='<?php echo e(route('admin.editUser', $user->id)); ?>'">
                                                    <i class="fas fa-edit"></i>
                                                    <span>Edit</span>
                                                </button>
                                                <form action="<?php echo e(route('admin.deleteUser', $user->id)); ?>" method="POST" class="delete-form">
                                                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/admin/users.blade.php ENDPATH**/ ?>