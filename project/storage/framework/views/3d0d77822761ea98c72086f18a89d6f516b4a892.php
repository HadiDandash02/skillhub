            ...
            <div class="header-content">
                ...
                <div class="header-stats">
                    <div class="stat-card">
                        ...
                        <div class="stat-info">
                            <span class="stat-number"><?php echo e($applications->count()); ?></span>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-info">
                            <span class="stat-number"><?php echo e($applications->where('status', 'Accepted')->count()); ?></span>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-info">
                            <span class="stat-number"><?php echo e($applications->where('status', 'Pending')->count()); ?></span>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-info">
                            <span class="stat-number"><?php echo e($applications->where('status', 'Rejected')->count()); ?></span>
                ...
                <div class="table-container">
                    <table class="applications-table" id="applicationsTable">
                        ...
                        <tbody>
                            ...
                            <tr class="application-row" data-status="<?php echo e(strtolower($application->status)); ?>">
                                <td class="applicant-cell">
                                    <div class="applicant-info">
                                        <div class="applicant-avatar">
                                            <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($application->user->name)); ?>&background=4f46e5&color=fff&size=48" 
                                        ...
                                        <div class="applicant-details">
                                            <div class="applicant-name"><?php echo e($application->user->name); ?></div>
                                ...
                                <td class="job-cell">
                                    <div class="job-info">
                                        <div class="job-title"><?php echo e($application->jobListing->title); ?></div>
                                ...
                                <td class="actions-cell">
                                    <div class="action-buttons">
                                        <!-- View Details Button -->
                                        <button class="view-details-btn" onclick="viewApplicationDetails(<?php echo e($application->id); ?>)" title="View Application Details">
                                            <i class="fas fa-eye"></i>
                                            <span>View Details</span>
                                        </button>
                                        
                                        <!-- Status Update Form -->
                                        <form action="<?php echo e(route('careerM.applications.update', $application->id)); ?>" method="POST" class="status-form">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                            <div class="form-group">
                                                <select name="status" class="status-select" onchange="this.form.submit()">
                                                    <option value="Applied" <?php echo e($application->status == 'Applied' ? 'selected' : ''); ?>>Applied</option>
...
<!-- Modal Overlay -->
<div id="modalOverlay" class="modal-overlay" onclick="closeApplicationModal()"></div>
...
<script>
// Enhanced functionality for the applications table with modal support
document.addEventListener('DOMContentLoaded', function() {
    ...
    function viewApplicationDetails(applicationId) {
        ...
        fetch(`/api/applications/${applicationId}/details`)
            .then(response => {
                if (!response.ok) {
            ...
            .catch(error => {
                ...
                modalBody.innerHTML = `
                    <div class="error-state">
                        ...
                        <p>Sorry, we couldn't load the application details. Please try again.</p>
                        <button onclick="viewApplicationDetails(${applicationId})" class="retry-button">
    ...
    function renderApplicationDetails(application) {
        ...
        const formatValue = (value) => {
            return value && value.trim() !== '' ? value : '<span class="empty">Not provided</span>';
        };
            ...
            <div class="application-details">
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-grid">
                        <div class="detail-item">
                            ...
                            <div class="detail-value">${application.user.name}</div>
                        </div>
                        <div class="detail-item">
                            <div class="detail-label">Email Address</div>
                            <div class="detail-value">${application.user.email}</div>
                        </div>
                        <div class="detail-item">
                            <div class="detail-label">Phone Number</div>
                            <div class="detail-value">${formatValue(application.phone)}</div>
                        </div>
                        <div class="detail-item">
                        ...
                        <div class="detail-item">
                            ...
                            <div class="detail-value">${formatValue(application.availability)}</div>
                        </div>
                        <div class="detail-item">
                            <div class="detail-label">Salary Expectation</div>
                            <div class="detail-value">
                                ${application.salary_expectation ? 
                                    `${parseInt(application.salary_expectation).toLocaleString()}` : 
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-grid">
                        <div class="detail-item">
                            ...
                            <div class="detail-value">${application.job_listing.title}</div>
                        </div>
                        <div class="detail-item">
                            <div class="detail-label">Company</div>
                            <div class="detail-value">${application.job_listing.company}</div>
                        </div>
                        <div class="detail-item">
                            <div class="detail-label">Location</div>
                            <div class="detail-value">${application.job_listing.location}</div>
                        </div>
                        <div class="detail-item">
                            <div class="detail-label">Employment Type</div>
                            <div class="detail-value">${application.job_listing.employment_type}</div>
                        </div>
                        <div class="detail-item">
                            <div class="detail-label">Salary Range</div>
                            <div class="detail-value">${application.job_listing.salary_range || '<span class="empty">Not specified</span>'}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="detail-section">
                    ...
                    <div class="cover-letter-content">
                        ${application.cover_letter || '<span class="empty">No cover letter provided</span>'}
                    </div>
                </div>
                ...
                <div class="detail-section">
                    ...
                    <div class="detail-item">
                        ${application.cv_path ? 
                            `<a href="/storage/${application.cv_path}" target="_blank" class="cv-download">
                                <i class="fas fa-download"></i>
                                Download CV/Resume
                            </a>` : 
                            '<span class="empty">No CV/Resume uploaded</span>'
                        }
                    </div>
                </div>
            </div>
    ...
    console.log('🚀 Professional Job Applications Dashboard with Modal loaded successfully!');
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/careerManager/applications.blade.php ENDPATH**/ ?>