...
<div class="create-quiz-page">
    ...
    <section class="quiz-header-section">
        <div class="quiz-header-container">
            <div class="header-content">
                ...
                <p class="header-description">Design engaging quizzes with multiple-choice questions to assess student learning</p>
                <div class="header-breadcrumb">
                    ...
                    <span class="breadcrumb-current">Create Quiz</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="quiz-content-wrapper">
        <div class="quiz-content-container">
            ...
            <!-- Course Info Card (if course is selected) -->
            <?php if(isset($course)): ?>
            <div class="course-info-card">
                <div class="course-info-header">
                    ...
                    <div class="course-details">
                        ...
                        <p class="course-subtitle">Adding quiz to this course</p>
                    </div>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="form-card">
                <div class="form-header">
                    ...
                    <p class="form-subtitle">Set up your quiz details and questions</p>
                </div>

                <div class="form-container">
                    <form method="POST" action="<?php echo e(route('admin.quizzes.store')); ?>" onsubmit="prepareQuizData()" class="quiz-form">
                        <?php echo csrf_field(); ?>
                        
                        <?php if(isset($course)): ?>
                        <input type="hidden" name="course_id" value="<?php echo e($course->id); ?>">
                        <?php endif; ?>
                        <input type="hidden" name="redirect_source" value="<?php echo e(request()->query('from', 'edit')); ?>">
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group form-group-full">
                                    ...
                                    <textarea id="description" name="description" class="form-control" rows="4" required 
                                              placeholder="Describe what this quiz covers and its learning objectives..."></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="questions-section">
                            ...
                            <div id="questions-container" class="questions-container">
                                ...
                                <!-- Empty State -->
                                <div class="empty-questions-state" id="empty-state">
                            ...
                            <div class="add-question-section" id="add-question-section" style="display: none;">
...
<style>
/* Professional Quiz Creation System Styles */
:root {
...
.course-info-card { animation-delay: 0.1s; }
...
<script>
    ...
    function addQuestion(data = null) {
        ...
        <div class="question-block" id="question-block-${index}" data-index="${index}">
            <div class="question-progress">
                <div class="question-progress-fill" style="width: 0%"></div>
            </div>
            ...
            <div class="smart-suggestions" id="suggestions-${index}">
                <div class="suggestions-header">
                    <i class="fas fa-robot"></i>
                    <span>Smart Suggestions</span>
                </div>
                <div id="suggestion-content-${index}"></div>
            </div>
        </div>`;
        ...
        // Add smooth scroll to new question
        setTimeout(() => {
        ...
        // Add floating button if there are questions
    ...
    function updateProgress() {
        ...
        blocks.forEach((block, index) => {
            ...
            const progressFill = block.querySelector('.question-progress-fill');
    ...
    function toggleFloatingButton() {
        const floatingBtn = document.querySelector('.floating-add-button');
    ...
    function prepareQuizData() {
        ...
        if (Object.keys(questions).length === 0) {
            showNotification('Please add at least one question to create a quiz.', 'warning');
            
            // Focus on add question button
            const addBtn = document.querySelector('.btn-add-first-question') || document.querySelector('.btn-add-question-dynamic');
            if (addBtn) {
        ...
        submitBtn.innerHTML = '<i class="fas fa-spinner fa-spin"></i> <span>Creating Quiz...</span>';
        submitBtn.disabled = true;
        submitBtn.classList.add('loading');
        
        // Show success notification
        showNotification('Quiz validation successful! Creating your quiz...', 'success');
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Don't add initial question automatically - let user choose
        ...
        floatingBtn.className = 'floating-add-button';
        floatingBtn.innerHTML = '<i class="fas fa-plus"></i>';
        floatingBtn.onclick = addQuestion;
        floatingBtn.setAttribute('data-tooltip', 'Add another question');
        ...
        // Smart suggestions (placeholder for AI integration)
        document.addEventListener('input', function(e) {
            if (e.target.classList.contains('question-text-input')) {
                const questionText = e.target.value.trim();
                if (questionText.length > 10) {
                    // Could integrate with AI service here
                    // showSmartSuggestions(questionText, e.target.closest('.question-block'));
                }
            }
        });
        ...
        console.log('🎯 Professional Quiz Creator with enhanced features loaded successfully!');
    });
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/admin/quizzes/create.blade.php ENDPATH**/ ?>