...
<div class="challenge-page">
    ...
    <section class="header-section">
        <div class="header-container">
            ...
            <div class="header-actions">
                <a href="<?php echo e(url()->previous()); ?>" class="btn-secondary-header">
    ...
    <div class="content-wrapper">
        <div class="content-container">
            <form method="POST" action="<?php echo e(route('instructor.challenges.update', $challenge->id)); ?>" class="challenge-form">
                <?php echo csrf_field(); ?>
                <?php echo method_field('PATCH'); ?>

                <input type="hidden" name="course_id" value="<?php echo e($challenge->course_id); ?>">
                ...
                <div class="challenge-status-banner">
                    ...
                    <div class="status-info">
                        ...
                        <h3 class="status-title"><?php echo e($challenge->title); ?></h3>
                    </div>
                    <div class="status-meta">
                        <div class="meta-item">
                            <i class="fas fa-clock"></i>
                            <span>Last updated: <?php echo e($challenge->updated_at->diffForHumans()); ?></span>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-content">
                        <div class="form-group span-full">
                            ...
                            <input type="text" name="title" id="title" value="<?php echo e(old('title', $challenge->title)); ?>" class="form-control" required>
                        ...
                        <div class="form-group span-full">
                            ...
                            <textarea name="description" id="description" class="form-control" rows="3" required><?php echo e(old('description', $challenge->description)); ?></textarea>
                        </div>
                        ...
                        <div class="form-group span-full">
                            ...
                            <textarea name="instructions" id="instructions" class="form-control" rows="4" required><?php echo e(old('instructions', $challenge->instructions)); ?></textarea>
                        </div>
                        ...
                        <div class="form-group span-full">
                            ...
                            <textarea name="code_placeholder" id="code_placeholder" class="form-control code-editor" rows="6" required><?php echo e(old('code_placeholder', $challenge->code_placeholder)); ?></textarea>
                        ...
                        <div class="form-group span-full">
                            ...
                            <textarea name="expected_output" id="expected_output" class="form-control" rows="2" required><?php echo e(old('expected_output', $challenge->expected_output)); ?></textarea>
                        </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="time_limit" id="time_limit" value="<?php echo e(old('time_limit', $challenge->time_limit ?? 10)); ?>" class="form-control" min="1" max="20">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="test_function_name" id="test_function_name" value="<?php echo e(old('test_function_name', $challenge->test_function_name)); ?>" class="form-control" placeholder="e.g., reverseString">
                ...
                <div class="form-section">
                    <div class="section-header">
                        ...
                        <div class="section-content-header">
                            ...
                            <div class="section-subtitle">
                                ...
                                <span class="test-count-badge"><?php echo e($challenge->testCases->count()); ?> test cases</span>
                            </div>
                        </div>
                    ...
                    <div class="form-content">
                        <div id="testCasesContainer" class="test-cases-container">
                            <?php $__currentLoopData = $challenge->testCases; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $testCase): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="test-case-item enhanced" data-index="<?php echo e($index); ?>">
                                <div class="test-case-header">
                                    <div class="test-case-info">
                                        <div class="test-case-number"><?php echo e($index + 1); ?></div>
                                        <div class="test-case-details">
                                            <h4 class="test-case-title">Test Case <?php echo e($index + 1); ?></h4>
                                            <span class="visibility-badge <?php echo e($testCase->is_hidden ? 'hidden' : 'visible'); ?>">
                                                <i class="fas fa-<?php echo e($testCase->is_hidden ? 'eye-slash' : 'eye'); ?>"></i>
                                                <?php echo e($testCase->is_hidden ? 'Hidden' : 'Visible'); ?>
                                    ...
                                    <div class="test-case-actions">
                                        ...
                                        <button type="button" class="btn-remove" onclick="removeTestCase(<?php echo e($index); ?>)">
                                ...
                                <div class="test-case-content">
                                    <div class="form-row">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="test_cases[<?php echo e($index); ?>][input]" value="<?php echo e($testCase->input); ?>" class="form-control" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="test_cases[<?php echo e($index); ?>][expected_output]" value="<?php echo e($testCase->expected_output); ?>" class="form-control" required>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="test_cases[<?php echo e($index); ?>][description]" value="<?php echo e($testCase->description); ?>" class="form-control" placeholder="Test case description">
                                    </div>

                                    <input type="hidden" name="test_cases[<?php echo e($index); ?>][is_hidden]" value="<?php echo e($testCase->is_hidden ? '1' : '0'); ?>">
                                </div>
                            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    let testCaseIndex = <?php echo e($challenge->testCases->count()); ?>; // Start from existing count
    ...
    window.runPreviewTest = function() {
        ...
        fetch(`/instructor/challenges/<?php echo e($challenge->id); ?>/preview`, {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/instructor/challenges/edit.blade.php ENDPATH**/ ?>