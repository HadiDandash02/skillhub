        ...
        <div class="jobs-header-container">
            <div class="header-content">
                ...
                <div class="header-stats">
                    <div class="stat-item">
                        <i class="fas fa-briefcase"></i>
                        <span id="totalJobsCount"><?php echo e(count($jobs)); ?> Active Jobs</span>
                    </div>
                    <div class="stat-item">
        ...
        <div class="jobs-content-container">
            ...
            <div class="quick-actions-section">
                <div class="action-card primary-action">
                    ...
                    <a href="<?php echo e(route('careerM.jobs.create')); ?>" class="action-button">
            ...
            <div class="management-controls">
                ...
                <div class="filter-section">
                    <form method="GET" action="<?php echo e(route('careerM.jobs')); ?>" class="filter-form">
                        <div class="filter-container">
                            <div class="filter-input-wrapper">
                                ...
                                <select name="location" class="location-select">
                                    ...
                                    <?php
                                        $uniqueLocations = collect($jobs)->pluck('location')->unique()->sort();
                                    ?>
                                    <?php $__currentLoopData = $uniqueLocations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="table-card">
                    ...
                    <div class="table-actions">
                        <div class="job-stats">
                            ...
                            <div class="stat-badge">
                                ...
                                <span id="companiesCount"><?php echo e($totalCompanies); ?> Companies</span>
                            </div>
                            <div class="stat-badge">
                                <i class="fas fa-map-marker-alt"></i>
                                <span id="locationsCount"><?php echo e($totalLocations); ?> Locations</span>
                            </div>
                            <div class="stat-badge">
                                <i class="fas fa-eye"></i>
                                <span id="visibleJobsCount"><?php echo e(count($jobs)); ?> Jobs Shown</span>
                            </div>
                        </div>
                    </div>
                </div>
                                        ...
                                        <td class="company-cell">
                                            <div class="company-info">
                                                <span class="company-badge">
                                                    <i class="fas fa-building"></i>
                                                    <span class="company-name"><?php echo e($job->company); ?></span>
                                                </span>
                                            </div>
                                        </td>
                                        <td class="location-cell">
                                            <div class="location-info">
                                                <span class="location-badge">
                                                    <i class="fas fa-map-marker-alt"></i>
                                                    <span class="location-name"><?php echo e($job->location); ?></span>
                                                </span>
                                            </div>
                                        </td>
                                        <td class="actions-cell">
                                            <div class="action-buttons">
                                                <button type="button" class="btn btn-edit" onclick="window.location.href='<?php echo e(route('careerM.jobs.edit', $job->id)); ?>'" title="Edit Job">
                                                    <i class="fas fa-edit"></i>
                                                    <span>Edit</span>
                                                </button>
                                                <form action="<?php echo e(route('careerM.jobs.delete', $job->id)); ?>" method="POST" class="delete-form">
                                                    <?php echo csrf_field(); ?>
                ...
                <div class="empty-state">
                    ...
                    <a href="<?php echo e(route('careerM.jobs.create')); ?>" class="btn-empty-action">
                        <i class="fas fa-plus"></i>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🚀 Professional Job Management with Search loaded');
    
    // Enhanced search functionality
    const searchInput = document.getElementById("searchInput");
    const jobRows = document.querySelectorAll("#jobTableBody .job-row");
    const totalJobsElement = document.getElementById("totalJobsCount");
    const visibleJobsElement = document.getElementById("visibleJobsCount");
    const companiesCountElement = document.getElementById("companiesCount");
    const locationsCountElement = document.getElementById("locationsCount");
    
    const originalCounts = {
        total: totalJobsElement ? totalJobsElement.textContent : '',
        visible: visibleJobsElement ? visibleJobsElement.textContent : '',
        companies: companiesCountElement ? companiesCountElement.textContent : '',
        locations: locationsCountElement ? locationsCountElement.textContent : ''
    };
    ...
    if (searchInput) {
        searchInput.addEventListener("keyup", function() {
            ...
            jobRows.forEach(row => {
                ...
                if (titleCell && companyCell && locationCell) {
                    const title = titleCell.textContent.toLowerCase();
                    const company = companyCell.textContent.toLowerCase();
                    const location = locationCell.textContent.toLowerCase();
                    
                    if (title.includes(searchText) || company.includes(searchText) || location.includes(searchText)) {
                        row.style.display = "";
                        visibleCount++;
                        visibleCompanies.add(companyCell.textContent);
                        visibleLocations.add(locationCell.textContent);
            ...
            if (searchText) {
                if (totalJobsElement) {
                    totalJobsElement.innerHTML = `Found: ${visibleCount} Jobs`;
                }
                if (visibleJobsElement) {
                    visibleJobsElement.innerHTML = `Found: ${visibleCount} Jobs`;
                }
                if (companiesCountElement) {
                    companiesCountElement.innerHTML = `<i class="fas fa-building"></i> ${visibleCompanies.size} Companies`;
                }
                if (locationsCountElement) {
                    locationsCountElement.innerHTML = `<i class="fas fa-map-marker-alt"></i> ${visibleLocations.size} Locations`;
                }
            } else {
                if (totalJobsElement) {
                    totalJobsElement.textContent = originalCounts.total;
                }
                if (visibleJobsElement) {
                    visibleJobsElement.textContent = originalCounts.visible;
                }
                if (companiesCountElement) {
                    companiesCountElement.innerHTML = originalCounts.companies;
                }
                if (locationsCountElement) {
                    locationsCountElement.innerHTML = originalCounts.locations;
                }
            }
        });
    }
    ...
    const formInputs = document.querySelectorAll('.search-input, .location-select');
    ...
    console.log('✨ Professional Job Management with Search & Filter fully initialized!');
});
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/careerManager/jobs/index.blade.php ENDPATH**/ ?>