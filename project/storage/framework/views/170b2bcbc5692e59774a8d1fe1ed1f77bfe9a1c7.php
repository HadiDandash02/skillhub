...
<div class="course-page">
    ...
    <div class="content-wrapper">
        <div class="content-container">
            <form method="POST" action="<?php echo e(route('admin.courses.update', $course->id)); ?>" class="edit-course-form">
                <?php echo csrf_field(); ?>
            ...
            <div class="card form-card">
                ...
                <div class="card-body">
                            ...
                            <?php $__currentLoopData = $course->chapters; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $chapter): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="chapter-item">
                                    ...
                                    <div id="chapter-details-<?php echo e($chapter->id); ?>" class="chapter-details" style="display:none;">
                                        <form method="POST" action="<?php echo e(route('admin.chapters.update', $chapter->id)); ?>" class="chapter-form">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                            <div class="form-group">
                                            ...
                                            <div class="form-actions">
                                                ...
                                                <form action="<?php echo e(route('admin.chapters.destroy', $chapter->id)); ?>" method="POST" class="inline-form" onsubmit="return confirm('Are you sure you want to delete this chapter?');">
                                                    <?php echo csrf_field(); ?>
                                        ...
                                        <div class="materials-section">
                                                    ...
                                                    <?php $__currentLoopData = $chapter->pdfs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $pdf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="material-item">
                                                            ...
                                                            <div class="material-actions">
                                                                ...
                                                                <form action="<?php echo e(route('admin.pdfs.destroy', $pdf->id)); ?>" method="POST" class="inline-form">
                                                                    <?php echo csrf_field(); ?>
                                                                    <?php echo method_field('DELETE'); ?>
                                            ...
                                            <div class="add-material-form">
                                                ...
                                                <form id="pdf-form-<?php echo e($chapter->id); ?>" action="<?php echo e(route('admin.pdfs.store')); ?>" method="POST" enctype="multipart/form-data" class="material-form" style="display: none;">
                                                    <?php echo csrf_field(); ?>
                    ...
                    <div id="add-chapter-form" class="add-chapter-form" style="display: none;">
                        <form method="POST" action="<?php echo e(route('admin.chapters.store')); ?>" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
            ...
            <div class="card form-card">
                ...
                <div class="card-body">
                    ...
                    <div class="content-section">
                                ...
                                <?php $__currentLoopData = $course->quizzes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quiz): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="related-item">
                                        ...
                                        <div class="related-item-actions">
                                            <a href="<?php echo e(route('admin.quizzes.edit', $quiz->id)); ?>" class="btn-icon btn-edit-related">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="<?php echo e(route('admin.quizzes.destroy', $quiz->id)); ?>" method="POST" class="inline-form" onsubmit="return confirm('Are you sure?');">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                        ...
                        <?php endif; ?>
                        <a href="<?php echo e(route('admin.quizzes.create', ['course_id' => $course->id])); ?>" class="btn-create-content">
                    ...
                    <div class="content-section">
                            ...
                            <div class="related-items-grid">
                                <?php $__currentLoopData = $course->challenges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $challenge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="related-item">
                                        ...
                                        <div class="related-item-actions">
                                            <a href="<?php echo e(route('admin.challenges.edit', $challenge->id)); ?>" class="btn-icon btn-edit-related">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="<?php echo e(route('admin.challenges.destroy', $challenge->id)); ?>" method="POST" class="inline-form" onsubmit="return confirm('Are you sure?');">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('DELETE'); ?>
                                                <button type="submit" class="btn-icon btn-delete-related">
                                                    <i class="fas fa-trash"></i>
                        ...
                        <?php endif; ?>
                        <a href="<?php echo e(route('admin.challenges.create', ['course_id' => $course->id])); ?>" class="btn-create-content">
                    ...
                    <div class="content-section">
                                ...
                                <?php $__currentLoopData = $course->tutorials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tutorial): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="tutorial-item">
                                        ...
                                        <div class="tutorial-actions">
                                            <form action="<?php echo e(route('admin.courses.tutorials.destroy', ['id' => $tutorial->id])); ?>" 
                        ...
                        <form action="<?php echo e(route('admin.courses.tutorial.add', ['id' => $course->id])); ?>"
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/admin/courses/edit.blade.php ENDPATH**/ ?>