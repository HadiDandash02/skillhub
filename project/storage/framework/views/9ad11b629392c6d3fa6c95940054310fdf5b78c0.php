...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'SkillHub - Professional Learning & Career Platform'); ?></title>
    <meta name="description" content="<?php echo $__env->yieldContent('description', 'Advance your career with SkillHub - Complete learning management system with personalized career development tools'); ?>">
        ...
        <nav>
            ...
            <div class="nav-right-section">
                <div class="nav-user-info">
                    ...
                    <div class="user-profile-section" onclick="window.location.href='<?php echo e(route('profile.edit')); ?>'">
                    ...
                    <div class="user-profile-section" onclick="window.location.href='<?php echo e(route('login')); ?>'">
                        <div class="user-avatar">
                            G
                        </div>
                        <div class="user-details">
            ...
            <div class="mobile-menu" id="mobileMenu">
                ...
                <ul>
                    <?php if(auth()->guard()->guest()): ?>
                        ...
                        <li><a href="<?php echo e(url('/lms')); ?>" class="<?php echo e(request()->is('lms*') ? 'active' : ''); ?>">
                            <i class="fas fa-book"></i>
                            LMS
                        </a></li>
                        <li><a href="<?php echo e(route('careerservices')); ?>" class="<?php echo e(request()->routeIs('careerservices') ? 'active' : ''); ?>">
                    ...
                    <?php if(auth()->guard()->check()): ?>
                        <?php if(auth()->user()->role === 'admin'): ?>
                            <li><a href="<?php echo e(route('admin.dashboard')); ?>" class="<?php echo e(request()->routeIs('admin.*') ? 'active' : ''); ?>">
                                <i class="fas fa-tachometer-alt"></i>
                                Admin Dashboard
                            </a></li>
                            <li><a href="<?php echo e(route('admin.applications')); ?>" class="<?php echo e(request()->routeIs('admin.applications') ? 'active' : ''); ?>">
                        ...
                        <?php if(auth()->user()->role === 'instructor'): ?>
                            <li><a href="<?php echo e(route('instructor.dashboard')); ?>" class="<?php echo e(request()->routeIs('instructor.*') ? 'active' : ''); ?>">
                        ...
                        <?php if(auth()->user()->role === 'careerM'): ?>
                            <li><a href="<?php echo e(route('careerM.jobs')); ?>" class="<?php echo e(request()->routeIs('careerM.jobs') ? 'active' : ''); ?>">
                                <i class="fas fa-briefcase"></i>
                                Jobs
                            </a></li>
                            <li><a href="<?php echo e(route('careerM.career-advice')); ?>" class="<?php echo e(request()->routeIs('careerM.career-advice') ? 'active' : ''); ?>">
                                <i class="fas fa-lightbulb"></i>
                                Career Advice
                            </a></li>
                            <li><a href="<?php echo e(route('careerM.applications')); ?>" class="<?php echo e(request()->routeIs('careerM.applications') ? 'active' : ''); ?>">
                                <i class="fas fa-file-alt"></i>
                                Job Applications
                            </a></li>
                        <?php endif; ?>
                ...
                <div class="menu-section">
                    ...
                    <ul>
                        <li><a href="<?php echo e(route('profile.edit')); ?>" class="<?php echo e(request()->routeIs('profile.*') ? 'active' : ''); ?>">
                ...
                <div class="menu-section">
                    ...
                    <ul>
                        <li><a href="<?php echo e(route('login')); ?>" class="<?php echo e(request()->routeIs('login') ? 'active' : ''); ?>">
                            <i class="fas fa-sign-in-alt"></i>
                            Sign In
                        </a></li>
                        <li><a href="<?php echo e(route('register')); ?>" class="<?php echo e(request()->routeIs('register') ? 'active' : ''); ?>">
        ...
        <div class="footer-content">
            ...
            <div class="footer-bottom">
                <div class="footer-bottom-content">
                    <div class="copyright">
                        <p>&copy; <?php echo e(date('Y')); ?> SkillHub. All rights reserved.</p>
                    </div>
...
</html><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/layouts/app.blade.php ENDPATH**/ ?>