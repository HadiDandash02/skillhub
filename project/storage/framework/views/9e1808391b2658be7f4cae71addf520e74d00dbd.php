        ...
        <div class="create-content-container">
            ...
            <div class="form-card">
                ...
                <div class="form-container">
                    <form method="POST" action="<?php echo e(route('admin.storeUser')); ?>" class="create-user-form">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <option value="instructor" <?php echo e(old('role') === 'instructor' ? 'selected' : ''); ?>>
                                            👨‍🏫 Instructor - Course management
                                        </option>
                                        <option value="careerM" <?php echo e(old('role') === 'careerM' ? 'selected' : ''); ?>>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/admin/create-user.blade.php ENDPATH**/ ?>