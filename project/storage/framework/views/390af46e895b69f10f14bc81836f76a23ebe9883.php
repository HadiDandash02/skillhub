...
<div class="challenge-page">
    ...
    <div class="content-wrapper">
        <div class="content-container">
            <form method="POST" action="<?php echo e(route('admin.challenges.update', $challenge->id)); ?>" class="challenge-form">
                <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.runPreviewTest = function() {
        ...
        fetch(`/admin/challenges/<?php echo e($challenge->id); ?>/preview`, {
            method: 'POST',
            headers: {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/admin/challenges/edit.blade.php ENDPATH**/ ?>