...
<div class="job-page">
    ...
    <section class="header-section">
        <div class="header-container">
            ...
            <div class="header-actions">
                <a href="<?php echo e(route('admin.jobs')); ?>" class="btn-secondary-header">
    ...
    <div class="content-wrapper">
        <div class="content-container">
            <form method="POST" action="<?php echo e(route('admin.jobs.update', $job->id)); ?>" class="edit-job-form">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company" id="company" 
                                           value="<?php echo e(old('company', $job->company)); ?>" class="form-control <?php $__errorArgs = ['company'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="location" id="location" 
                                           value="<?php echo e(old('location', $job->location)); ?>" class="form-control <?php $__errorArgs = ['location'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>">
                                        ...
                                        <option value="Entry Level" <?php echo e(old('experience_level', $job->experience_level) == 'Entry Level' ? 'selected' : ''); ?>>Entry Level</option>
                                        <option value="Mid Level" <?php echo e(old('experience_level', $job->experience_level) == 'Mid Level' ? 'selected' : ''); ?>>Mid Level</option>
                                        <option value="Senior Level" <?php echo e(old('experience_level', $job->experience_level) == 'Senior Level' ? 'selected' : ''); ?>>Senior Level</option>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="salary_range" id="salary_range" 
                                           value="<?php echo e(old('salary_range', $job->salary_range)); ?>" class="form-control <?php $__errorArgs = ['salary_range'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="deadline" id="deadline" 
                                           value="<?php echo e(old('deadline', $job->deadline ? $job->deadline->format('Y-m-d') : '')); ?>" class="form-control <?php $__errorArgs = ['deadline'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                        ...
                        <div class="form-group">
                            <div class="checkbox-group">
                                <input type="checkbox" name="remote_option" id="remote_option" value="1" 
                                       <?php echo e(old('remote_option', $job->remote_option) ? 'checked' : ''); ?> class="checkbox-input">
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="6" required placeholder="Provide a detailed job description"><?php echo e(old('description', $job->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="4" placeholder="List the job requirements (one per line)"><?php echo e(old('requirements', $job->requirements)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="4" placeholder="List the key responsibilities (one per line)"><?php echo e(old('responsibilities', $job->responsibilities)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="skills_required" id="skills_required" 
                                   value="<?php echo e(old('skills_required', is_array($job->skills_required) ? implode(', ', $job->skills_required) : $job->skills_required)); ?>" 
                                   class="form-control <?php $__errorArgs = ['skills_required'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="4" placeholder="List the benefits and perks (one per line)"><?php echo e(old('benefits', $job->benefits)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="4" placeholder="Tell candidates about your company..."><?php echo e(old('company_description', $job->company_description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="submit-group">
                        ...
                        <a href="<?php echo e(route('admin.jobs')); ?>" class="btn-cancel">
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🎯 Professional Job Edit Form Loaded');
    ...
    console.log('✅ Professional Job Edit Form Ready!');
});
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/admin/jobs/edit-job.blade.php ENDPATH**/ ?>