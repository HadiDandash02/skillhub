...
<div class="advice-page">
    ...
    <section class="header-section">
        <div class="header-container">
            <div class="header-content">
                ...
                <h1 class="header-title">Edit Career Advice</h1>
                <p class="header-description">Update and refine your professional guidance</p>
            </div>
            <div class="header-actions">
                <a href="<?php echo e(route('careerM.career-advice')); ?>" class="btn-secondary-header">
    ...
    <div class="content-wrapper">
        <div class="content-container">
            <form method="POST" action="<?php echo e(route('careerM.career-advice.update', $advice->id)); ?>" class="edit-advice-form">
                <?php echo csrf_field(); ?>
                ...
                <div class="card form-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" value="<?php echo e(old('title', $advice->title)); ?>" 
...
unset($__errorArgs, $__bag); ?>" required placeholder="Enter advice title">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="category" id="category" 
                                   value="<?php echo e(old('category', $advice->category)); ?>" class="form-control <?php $__errorArgs = ['category'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
                        ...
                        <div class="form-group">
                            ...
                            <div class="company-field-wrapper">
                                <input type="text" name="company" id="company"
                                       value="<?php echo e(old('company', $advice->company ?? $companyName ?? '')); ?>"
...
unset($__errorArgs, $__bag); ?>" 
                                      rows="10" required placeholder="Write your career advice content here... Share practical tips, insights, and actionable guidance that will help professionals advance in their careers."><?php echo e(old('content', $advice->content)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="submit-group">
                        <button type="submit" class="btn-submit">
                            <i class="fas fa-save"></i> Update Career Advice
                        </button>
                        <a href="<?php echo e(route('careerM.career-advice')); ?>" class="btn-cancel">Cancel</a>
                    </div>
                </div>
            </form>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        charCounter.innerHTML = '<i class="fas fa-keyboard"></i> <span id="char-count">' + contentTextarea.value.length + '</span> characters';
        ...
        console.log('🎨 Professional Career Advice Edit Form loaded!');
    });
</script>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/careerManager/advices/edit.blade.php ENDPATH**/ ?>