...
<?php $__env->startSection('title', 'Learning Management System - SkillHub'); ?>
<?php $__env->startSection('description', 'Explore interactive courses, AI-powered learning paths, and skill assessments on SkillHub\'s professional LMS platform.'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <section class="filters-section">
        <div class="filters-container">
            <form method="GET" action="<?php echo e(route('lms')); ?>">
                <div class="filters">
    ...
    <div style="display: flex; gap: 1rem; align-items: center; flex-wrap: wrap;">
        <p class="courses-count">
            ...
            <?php echo e($courses->total()); ?> courses available
        </p>
        <?php if($courses->total() > 6): ?>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $courses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $course): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="course-card">
                        <div class="course-content">
                            ...
                            <div class="course-info-row">
                             <div class="course-level <?php echo e(strtolower($course->difficulty)); ?>" data-difficulty="<?php echo e(strtolower($course->difficulty)); ?>">
                                <span>Level: <?php echo e($course->difficulty); ?></span>
                            </div>
                            <!-- Instructor Name -->
                            <div class="course-instructor">
                                <span>Instructor: <?php echo e($course->instructor); ?></span>
                            </div>
                            </div>
                           ...
                           <div class="rating-section">
                            ...
                            <span class="rating-text"><?php echo e(number_format($course->averageRating(), 2)); ?>/5</span>
                        </div>
                        <div class="course-info-row">
                        <!-- Views -->
                            <div class="course-views">
                                <span>Views: <?php echo e($course->views); ?></span>
                            </div>
                        </div>

                            <div class="course-actions">
                                <a href="<?php echo e(route('courses.show', $course->id)); ?>" class="btn-primary">
                            ...
                            <button class="btn-warning rate-toggle" data-course="<?php echo e($course->id); ?>">
                                <i class="fas fa-star"></i>
                                <?php echo e($course->isRated ? 'Rate' : 'Rate '); ?>
                    ...
                    <div class="rating-overlay hidden" id="rating-overlay-<?php echo e($course->id); ?>">
                        <div class="rating-popup">
                            ...
                            <form action="<?php echo e(route('ratings.store', $course->id)); ?>" method="POST" class="rating-form">
                                <?php echo csrf_field(); ?>
                                <h3 class="rating-title">Rate this Course</h3>
                                <div class="rating-stars">
                                    <?php for($i = 5; $i >= 1; $i--): ?>
                                        <input type="radio" id="star<?php echo e($i); ?>-<?php echo e($course->id); ?>" name="rating" value="<?php echo e($i); ?>" required>
                                        <label for="star<?php echo e($i); ?>-<?php echo e($course->id); ?>" class="star">&#9733;</label>
                                    <?php endfor; ?>
                                </div>
...
<?php if($courses->hasPages()): ?>
    <div class="pagination-container">
        ...
        <div class="page-info">
            ...
            Page <?php echo e($courses->currentPage()); ?> of <?php echo e($courses->lastPage()); ?>
        ...
        <div class="pagination">
            ...
            <?php else: ?>
                <a href="<?php echo e($courses->appends(request()->query())->previousPageUrl()); ?>" class="prev">
                    <i class="fas fa-chevron-left"></i>
                </a>
            <?php endif; ?>
            ...
            <?php if($start > 1): ?>
                <a href="<?php echo e($courses->appends(request()->query())->url(1)); ?>">1</a>
                <?php if($start > 2): ?>
            ...
            <?php for($i = $start; $i <= $end; $i++): ?>
                <?php if($i == $courses->currentPage()): ?>
                    <span class="current"><?php echo e($i); ?></span>
                <?php else: ?>
                    <a href="<?php echo e($courses->appends(request()->query())->url($i)); ?>"><?php echo e($i); ?></a>
                <?php endif; ?>
            <?php endfor; ?>

            
            <?php if($end < $courses->lastPage()): ?>
                <?php if($end < $courses->lastPage() - 1): ?>
                    <span class="dots">...</span>
                <?php endif; ?>
                <a href="<?php echo e($courses->appends(request()->query())->url($courses->lastPage())); ?>"><?php echo e($courses->lastPage()); ?></a>
            <?php endif; ?>

            
            <?php if($courses->hasMorePages()): ?>
                <a href="<?php echo e($courses->appends(request()->query())->nextPageUrl()); ?>" class="next">
        ...
        <!-- Quick Jump -->
        <?php if($courses->lastPage() > 5): ?>
            <div class="quick-jump">
                <label for="jumpToPage">
                    <i class="fas fa-external-link-alt"></i>
                    Jump to:
                </label>
                <input type="number" id="jumpToPage" min="1" max="<?php echo e($courses->lastPage()); ?>" 
                       value="<?php echo e($courses->currentPage()); ?>" placeholder="Page">
    ...
    <div class="modal-content">
        ...
        <div class="modal-footer">
            ...
            <div class="modal-actions">
                <a href="<?php echo e(route('register')); ?>" class="btn-modal-primary">
                    <i class="fas fa-user-plus"></i>
                    Create Free Account
                </a>
                <a href="<?php echo e(route('login')); ?>" class="btn-modal-secondary">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const isGuest = <?php echo json_encode(auth()->guest(), 15, 512) ?>;
...
console.log('- Guest status:', <?php echo json_encode(auth()->guest(), 15, 512) ?>);
</script>
...
window.jumpToPage = function() {
    ...
    if (page >= 1 && page <= maxPage) {
        ...
        pageInput.value = <?php echo e($courses->currentPage()); ?>;
    }
};
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/lms.blade.php ENDPATH**/ ?>