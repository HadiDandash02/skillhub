        ...
        <div class="edit-header-container">
            <div class="header-content">
                ...
                <div class="header-breadcrumb">
                    <a href="<?php echo e(route('admin.users')); ?>" class="breadcrumb-link">
        ...
        <div class="edit-content-container">
            ...
            <div class="user-info-card">
                <div class="user-header">
                    ...
                    <div class="user-details">
                        <h3 class="username"><?php echo e($user->name); ?></h3>
                        <p class="user-email"><?php echo e($user->email); ?></p>
                        <span class="current-role-badge role-<?php echo e(strtolower($user->role)); ?>">
                            <i class="fas fa-user-tag"></i>
                            Current Role: <?php echo e(ucfirst($user->role)); ?>

                        </span>
                        <?php if($user->role === 'careerM' && $user->company_name): ?>
                            <div class="company-info">
                                <i class="fas fa-building"></i>
                                <span>Company: <?php echo e($user->company_name); ?></span>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div class="form-card">
                ...
                <div class="form-container">
                    <form method="POST" action="<?php echo e(route('admin.updateUser', $user->id)); ?>" class="edit-user-form">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                        ...
                                        <option value="instructor" <?php echo e($user->role === 'instructor' ? 'selected' : ''); ?>>
                                            👨‍🏫 Instructor - Course management
                                        </option>
                                        <option value="careerM" <?php echo e($user->role === 'careerM' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="form-group form-group-full company-field" id="company-field" 
                                 style="display: <?php echo e($user->role === 'careerM' ? 'block' : 'none'); ?>;">
...
unset($__errorArgs, $__bag); ?>" 
                                           ...
                                           <?php echo e($user->role === 'careerM' ? 'required' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-actions">
                            ...
                            <button type="button" class="btn btn-secondary" onclick="window.location.href='<?php echo e(route('admin.users')); ?>'">
                ...
                <div class="info-content">
                    <div class="info-grid">
                        ...
                        <div class="info-item">
                            ...
                            <span class="info-value"><?php echo e($user->company_name); ?></span>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/admin/edit-users.blade.php ENDPATH**/ ?>