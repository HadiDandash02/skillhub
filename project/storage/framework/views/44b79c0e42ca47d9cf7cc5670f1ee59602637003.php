            ...
            <div class="header-content">
                ...
                <div class="header-meta">
                    <div class="meta-item">
                        ...
                        <span><?php echo e(date('F j, Y')); ?></span>
                    </div>
                    <div class="meta-item">
        ...
        <div class="dashboard-content-container">
            ...
            <div class="metrics-grid">
                <div class="metric-card users-card">
                    <div class="metric-header">
                        ...
                        <div class="metric-trend <?php echo e($usersGrowth >= 0 ? 'positive' : 'negative'); ?>">
                            <i class="fas fa-arrow-<?php echo e($usersGrowth >= 0 ? 'up' : 'down'); ?>"></i>
                            <span><?php echo e($usersGrowth >= 0 ? '+' : ''); ?><?php echo e($usersGrowth); ?>%</span>
                        </div>
                    </div>
                    <div class="metric-content">
                        <h3 class="metric-title">Total Users</h3>
                        <div class="metric-value"><?php echo e(number_format($totalUsers)); ?></div>
                ...
                <div class="metric-card courses-card">
                    <div class="metric-header">
                        ...
                        <div class="metric-trend <?php echo e($coursesGrowth >= 0 ? 'positive' : 'negative'); ?>">
                            <i class="fas fa-arrow-<?php echo e($coursesGrowth >= 0 ? 'up' : 'down'); ?>"></i>
                            <span><?php echo e($coursesGrowth >= 0 ? '+' : ''); ?><?php echo e($coursesGrowth); ?>%</span>
                        </div>
                    </div>
                    <div class="metric-content">
                        <h3 class="metric-title">Total Courses</h3>
                        <div class="metric-value"><?php echo e(number_format($totalCourses)); ?></div>
                ...
                <div class="metric-card jobs-card">
                    <div class="metric-header">
                        ...
                        <div class="metric-trend <?php echo e($jobsGrowth >= 0 ? 'positive' : 'negative'); ?>">
                            <i class="fas fa-arrow-<?php echo e($jobsGrowth >= 0 ? 'up' : 'down'); ?>"></i>
                            <span><?php echo e($jobsGrowth >= 0 ? '+' : ''); ?><?php echo e($jobsGrowth); ?>%</span>
                        </div>
                    </div>
                    <div class="metric-content">
                ...
                <div class="metric-card advice-card">
                    <div class="metric-header">
                        ...
                        <div class="metric-trend <?php echo e($adviceGrowth >= 0 ? 'positive' : 'negative'); ?>">
                            <i class="fas fa-arrow-<?php echo e($adviceGrowth >= 0 ? 'up' : 'down'); ?>"></i>
                            <span><?php echo e($adviceGrowth >= 0 ? '+' : ''); ?><?php echo e($adviceGrowth); ?>%</span>
                        </div>
                    </div>
                    <div class="metric-content">
                        <h3 class="metric-title">Career Advice</h3>
                        <div class="metric-value"><?php echo e(number_format($totalCareerAdvices)); ?></div>
                ...
                <div class="chart-card pie-chart">
                    ...
                    <div class="chart-legend">
                        <div class="legend-item">
                            ...
                            <span>Users (<?php echo e($totalUsers); ?>)</span>
                        </div>
                        <div class="legend-item">
                            <div class="legend-color" style="background: #10b981;"></div>
                            <span>Courses (<?php echo e($totalCourses); ?>)</span>
                        </div>
                        <div class="legend-item">
                            <div class="legend-color" style="background: #f59e0b;"></div>
                            <span>Job Listings (<?php echo e($totalJobs); ?>)</span>
                        </div>
                        <div class="legend-item">
                            <div class="legend-color" style="background: #8b5cf6;"></div>
                            <span>Career Advice (<?php echo e($totalCareerAdvices); ?>)</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="actions-grid">
                ...
                <div class="management-cards">
                    <a href="<?php echo e(route('admin.users')); ?>" class="management-card users-mgmt">
                        <div class="card-icon">
                    ...
                    <a href="<?php echo e(route('admin.courses')); ?>" class="management-card courses-mgmt">
                        <div class="card-icon">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-stats">
                                <span class="stat-item">
                                    ...
                                    <?php echo e($totalCourses); ?> courses
                                </span>
                            </div>
                        </div>
                        <div class="card-arrow">
                    ...
                    <a href="<?php echo e(route('admin.jobs')); ?>" class="management-card jobs-mgmt">
                        <div class="card-icon">
                            <i class="fas fa-briefcase"></i>
                        </div>
                        <div class="card-content">
                    ...
                    <a href="<?php echo e(route('admin.career-advice')); ?>" class="management-card advice-mgmt">
                        <div class="card-icon">
                        ...
                        <div class="card-content">
                            ...
                            <div class="card-stats">
                                <span class="stat-item">
                                    <i class="fas fa-lightbulb"></i>
                                    <?php echo e($totalCareerAdvices); ?> articles
                                </span>
                            </div>
                        </div>
                        <div class="card-arrow">
                ...
                <div class="activity-timeline">
                    <?php $__empty_1 = true; $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="timeline-item">
                            <div class="timeline-icon <?php echo e($activity['class']); ?>">
                                <i class="<?php echo e($activity['icon']); ?>"></i>
                            </div>
                            <div class="timeline-content">
                                <h5 class="timeline-title"><?php echo e($activity['title']); ?></h5>
                                <p class="timeline-description"><?php echo e($activity['description']); ?></p>
                                <span class="timeline-time"><?php echo e($activity['time']->diffForHumans()); ?></span>
                            </div>
                        </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const miniChartData = <?php echo json_encode($miniChartData, 15, 512) ?>;
    ...
    if (distributionCtx) {
        new Chart(distributionCtx, {
            ...
            data: {
                ...
                datasets: [{
                    data: [<?php echo e($totalUsers); ?>, <?php echo e($totalCourses); ?>, <?php echo e($totalJobs); ?>, <?php echo e($totalCareerAdvices); ?>],
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\ACER NITRO\Desktop\SkillHubProject\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>