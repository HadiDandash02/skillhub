...
<div class="course-page">
    ...
    <div class="content-wrapper">
        <div class="content-container">
            <form method="POST" action="{{ route('instructor.courses.update', $course->id) }}" class="edit-course-form">
                @csrf
                @method('PATCH')
            ...
            <div class="card form-card">
                ...
                <div class="card-body">
                            ...
                            @foreach($course->chapters as $chapter)
                                <div class="chapter-item">
                                    ...
                                    <div id="chapter-details-{{ $chapter->id }}" class="chapter-details" style="display:none;">
                                        <form method="POST" action="{{ route('instructor.chapters.update', $chapter->id) }}" class="chapter-form">
                                            @csrf
                                            @method('PATCH')
                                            <div class="form-group">
                                            ...
                                            <div class="form-actions d-flex align-items-center gap-2" style="display: flex; align-items: center; gap: 1rem;">
                                                <form method="POST" action="{{ route('instructor.chapters.update', $chapter->id) }}" class="chapter-form" style="margin-bottom: 0;">
                                                    @csrf
                                                    @method('PATCH')
                                                ...
                                                <form action="{{ route('instructor.chapters.destroy', $chapter->id) }}" method="POST" class="inline-form" style="margin-bottom: 0;" onsubmit="return confirm('Are you sure you want to delete this chapter?');">
                                                    @csrf
                                                    @method('DELETE')
                                        ...
                                        <div class="materials-section">
                                                    ...
                                                    @foreach($chapter->pdfs as $pdf)
                                                        <div class="material-item">
                                                            ...
                                                            <div class="material-actions">
                                                                ...
                                                                <form action="{{ route('instructor.pdfs.destroy', $pdf->id) }}" method="POST" class="inline-form">
                                                                    @csrf
                                                                    @method('DELETE')
                                            ...
                                            <div class="add-material-form">
                                                ...
                                                <form id="pdf-form-{{ $chapter->id }}" action="{{ route('instructor.pdfs.store') }}" method="POST" enctype="multipart/form-data" class="material-form" style="display: none;">
                                                    @csrf
                    ...
                    <div id="add-chapter-form" class="add-chapter-form" style="display: none;">
                        <form method="POST" action="{{ route('instructor.chapters.store') }}" enctype="multipart/form-data">
                            @csrf
            ...
            <div class="card form-card">
                ...
                <div class="card-body">
                    ...
                    <div class="content-section">
                                ...
                                @foreach ($course->quizzes as $quiz)
                                    <div class="related-item">
                                        ...
                                        <div class="related-item-actions">
                                            <a href="{{ route('instructor.quizzes.edit', $quiz->id) }}" class="btn-icon btn-edit-related">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('instructor.quizzes.destroy', $quiz->id) }}" method="POST" class="inline-form" onsubmit="return confirm('Are you sure?');">
                                                @csrf
                                                @method('DELETE')
                        ...
                        @endif
                        <a href="{{ route('instructor.quizzes.create', ['course_id' => $course->id]) }}" class="btn-create-content">
                    ...
                    <div class="content-section">
                            ...
                            <div class="related-items-grid">
                                @foreach ($course->challenges as $challenge)
                                    <div class="related-item">
                                        ...
                                        <div class="related-item-actions">
                                            <a href="{{ route('instructor.challenges.edit', $challenge->id) }}" class="btn-icon btn-edit-related">
                                                <i class="fas fa-edit"></i>
                                            </a>
                                            <form action="{{ route('instructor.challenges.destroy', $challenge->id) }}" method="POST" class="inline-form" onsubmit="return confirm('Are you sure?');">
                                                @csrf
                                                @method('DELETE')
                                                <button type="submit" class="btn-icon btn-delete-related">
                                                    <i class="fas fa-trash"></i>
                        ...
                        @endif
                        <a href="{{ route('instructor.challenges.create', ['course_id' => $course->id]) }}" class="btn-create-content">
                    ...
                    <div class="content-section">
                                ...
                                @foreach ($course->tutorials as $tutorial)
                                    <div class="tutorial-item">
                                        ...
                                        <div class="tutorial-actions">
                                            <form action="{{ route('instructor.courses.tutorials.destroy', ['id' => $tutorial->id]) }}" 
                        ...
                        <form action="{{ route('instructor.courses.tutorial.add', ['id' => $course->id]) }}"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('🎨 Professional Instructor Course Edit Form loaded!');
});
</script>
