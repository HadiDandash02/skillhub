        ...
        <div class="index-content-container">
            ...
            <div class="management-controls">
                ...
                <div class="filter-section">
                    <form method="GET" action="{{ route('instructor.courses') }}" class="difficulty-filter-form">
            ...
            <div class="professional-table-container professional-fade-in">
                <div class="table-header">
                    ...
                    <div class="table-actions">
                        <a href="{{ route('instructor.courses.create') }}" class="btn-add-course">
                            <i class="fas fa-plus"></i>
                            <span>Add New Course</span>
                        </a>
                        <div class="table-stats">
                            <i class="fas fa-chart-bar"></i>
                            <span id="courseCount">{{ count($courses) }} Total Courses</span>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr class="course-row">
                                        ...
                                        <td class="difficulty-cell">
                                            <span class="difficulty-badge difficulty-{{ strtolower($course->difficulty) }}">
                                                <i class="fas fa-{{ $course->difficulty === 'Beginner' ? 'leaf' : ($course->difficulty === 'Intermediate' ? 'star' : 'fire') }}"></i>
                                                {{ $course->difficulty }}
                                            </span>
                                        </td>
                                        <td class="count-cell">
                                            <span class="professional-count-badge">{{ $course->chapters->count() }}</span>
                                        </td>
                                        <td class="count-cell">
                                            <span class="professional-count-badge">{{ $course->quizzes->count() }}</span>
                                        </td>
                                        <td class="count-cell">
                                            <span class="professional-count-badge">{{ $course->challenges->count() }}</span>
                                        </td>
                                        <td class="actions-cell">
                                            <div class="action-buttons-container">
                                                <a href="{{ route('instructor.courses.edit', $course->id) }}" class="btn-professional btn-edit">
                                                    <i class="fas fa-edit"></i> Edit
                                                </a>
                                                <form action="{{ route('instructor.courses.delete', $course->id) }}" method="POST" class="professional-inline-form">
                                                    @csrf
                                                    @method('DELETE')
                                                ...
                                                <a href="{{ route('courses.show', $course->id) }}" class="btn-professional btn-view">
