        ...
        <div class="quiz-content-container">
            ...
            <div class="form-card">
                ...
                <div class="form-container">
                    <form method="POST" action="{{ route('instructor.quizzes.update', $quiz->id) }}" onsubmit="prepareQuizData()" class="quiz-form">
                        @csrf
                        @method('PATCH')
                            ...
                            <div class="form-grid">
                                ...
                                <div class="form-group form-group-full">
                                    ...
                                    <textarea id="description" name="description" class="form-control" rows="4" required 
                                              placeholder="Describe what this quiz covers and its learning objectives...">{{ $quiz->description }}</textarea>
                                </div>
                            </div>
                        </div>
...
<script>
    let questionCount = 0;
    const existingQuestions = {!! $quiz->questions !!}; // assuming this is JSON
