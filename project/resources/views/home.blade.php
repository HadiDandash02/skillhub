...
@section('title', 'SkillHub - Professional Learning & Career Platform')
@section('description', 'Advance your tech career with SkillHub\'s comprehensive LMS, job matching, resume builder, and personalized learning paths.')
...
@section('content')
            ...
            <div class="hero-content">
                <div class="hero-text">
                    ...
                    <div class="hero-buttons">
                        @auth
                            <a href="{{ url('/lms') }}" class="btn-hero-primary">
                                <i class="fas fa-play-circle"></i>
                                <span>Continue Learning</span>
                            </a>
                            <a href="{{ route('careerservices') }}" class="btn-hero-secondary">
    ...
    <section class="services-section">
        <div class="services-container">
            ...
            <div class="services-grid">
                <a href="{{ url('/lms') }}" class="service-card">
                ...
                <a href="{{ route('careerservices') }}" class="service-card">
                    <div class="service-icon">
                        <i class="fas fa-briefcase"></i>
                    </div>
    ...
    {{-- <section class="cta-section">
        <div class="cta-container">
            ...
            <h3>Transform Your Career Journey</h3>
            <p>Join a community of ambitious professionals who are already advancing their careers with SkillHub's comprehensive learning platform.</p>
