        ...
        @if($jobListings->count() > 0)
            ...
            <div class="jobs-container">
                <div class="jobs-grid" id="jobsGrid">
                    @foreach($jobListings->take(5) as $job)
                        <div class="job-card" data-searchable="{{ strtolower($job->title . ' ' . $job->company . ' ' . $job->location) }}">
                                ...
                                @if($job->skills_required && is_array($job->skills_required))
                                    <div class="job-skills">
                                        ...
                                        @if(count($job->skills_required) > 3)
                                            <span class="skill-tag-small more-skills">+{{ count($job->skills_required) - 3 }} more</span>
                                        @endif
                                    </div>
                                @endif
                            </div>
                ...
                <div class="hidden-jobs" id="hiddenJobs" style="display: none;">
                    @foreach($jobListings->skip(5) as $job)
                        <div class="job-card" data-searchable="{{ strtolower($job->title . ' ' . $job->company . ' ' . $job->location) }}">
                            <div class="job-header">
                                <h4 class="job-title">{{ $job->title }}</h4>
                                <div class="job-company">
                ...
                @if($jobListings->count() > 5)
                    <div class="load-more-section">
                        <button id="loadMoreJobs" class="btn-load-more">
                            ...
                            <span>Show {{ $jobListings->count() - 5 }} More Jobs</span>
                        </button>
            ...
            <div class="service-card">
                ...
                <div class="service-content">
                    <div class="text-center">
                        ...
                        <a href="{{ route('resume.builder') }}" class="btn-generate">
            ...
            <div class="advice-container">
                <div class="advice-scrollable-container" id="adviceScrollContainer">
                    <div class="advice-categories" id="adviceCategories">
                        @foreach($careerAdvices as $category => $advices)
                            <div class="advice-category" data-category="{{ strtolower($category) }}">
                                <h3 class="category-title">
                                    <i class="fas fa-tag"></i>
                                    {{ ucfirst($category) }} Tips
                                </h3>
                                <div class="advice-grid">
                                    @foreach($advices as $advice)
                                        <div class="advice-card" data-searchable="{{ strtolower($advice->title . ' ' . $category . ' ' . ($advice->careerManager->company_name ?? '')) }}">
                                            <div class="advice-header">
                                                <h4 class="advice-title">{{ $advice->title }}</h4>
                                                <div class="advice-meta">
                                                    <div class="advice-company">
                                                        <i class="fas fa-building"></i>
                                                        <span>{{ $advice->careerManager->company_name ?? 'Career Expert' }}</span>
                                                    </div>
                                                    <div class="advice-date">
                                                        <i class="fas fa-calendar"></i>
                                                        <span>{{ $advice->created_at->format('M d, Y') }}</span>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="advice-content">
                                                <p class="advice-excerpt">{{ Str::limit($advice->content, 120) }}</p>
                                            </div>
                                            <div class="advice-actions">
                                                <a href="{{ route('careerAdvice.show', $advice->id) }}" class="btn-read-more">
                                    ...
                                    <table class="tracker-table">
                                        ...
                                        <tbody id="applicationsTableBody">
                                            @foreach(Auth::user()->jobApplications as $application)
                                                <tr class="tracker-row" data-searchable="{{ strtolower($application->jobListing->title . ' ' . $application->jobListing->company . ' ' . $application->status) }}">
                                                    <td class="job-title-cell">
                                                        <strong>{{ $application->jobListing->title }}</strong>
                                                    </td>
