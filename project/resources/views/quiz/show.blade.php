...
@section('title', $quiz->title . ' - Quiz Assessment | SkillHub')
@section('description', 'Take the ' . $quiz->title . ' quiz to test your knowledge and skills.')
...
<div class="quiz-wrapper">
    <div class="quiz-container">
                    ...
                    <div class="question" data-question="{{ $index }}">
                        ...
                        <div class="options-list">
                            @foreach($question['options'] as $optionIndex => $option)
                                <label class="option" for="q{{ $index }}_{{ $optionIndex }}">
                                    <input type="radio" 
        ...
        <div class="quiz-navigation">
            <a href="{{  route('courses.show', $quiz->course_id)  }}" class="btn-back">
...
<div class="modal-overlay show" id="result-modal">
    <div class="result-modal">
        ...
        <div class="result-icon {{ $percentage >= 80 ? '' : ($percentage >= 60 ? 'low-score' : 'fail-score') }}">
            @if($percentage >= 80)
        ...
        <div class="result-message {{ $percentage >= 80 ? '' : ($percentage >= 60 ? 'warning' : 'danger') }}">
            @if($percentage >= 80)
        ...
        <div class="result-details">
            ...
            <div class="result-item">
                <div class="result-value">{{ $total - $score }}</div>
        ...
        <div class="result-actions">
            ...
            @endif
            <a href="{{ route('courses.show', $quiz->course_id)  }}" class="btn-secondary">
                <i class="fas fa-arrow-left"></i>
                Back to Course
            </a>
        </div>
