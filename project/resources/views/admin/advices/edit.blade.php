...
<div class="advice-page">
    ...
    <section class="header-section">
        <div class="header-container">
            ...
            <div class="header-actions">
                <a href="{{ route('admin.career-advice') }}" class="btn-secondary-header">
    ...
    <div class="content-wrapper">
        <div class="content-container">
            <form method="POST" action="{{ route('admin.career-advice.update', $advice->id) }}" class="edit-advice-form">
                @csrf
                @method('PATCH')
                ...
                <div class="card form-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $advice->title) }}" 
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="category" id="category" 
                                   value="{{ old('category', $advice->category) }}" class="form-control @error('category') is-invalid @enderror" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="content" id="content" class="form-control @error('content') is-invalid @enderror" 
                                      rows="10" required placeholder="Write your career advice content here... Share practical tips, insights, and actionable guidance that will help professionals advance in their careers.">{{ old('content', $advice->content) }}</textarea>
                            @error('content')
                                <span class="form-error">{{ $message }}</span>
                            @enderror
                            <div class="form-help">
                    ...
                    <div class="submit-group">
                        ...
                        <a href="{{ route('admin.career-advice') }}" class="btn-cancel">Cancel</a>
                    </div>
                </div>
            </form>
