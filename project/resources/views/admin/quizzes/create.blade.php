        ...
        <div class="quiz-content-container">
            ...
            <div class="form-card">
                ...
                <div class="form-container">
                    <form method="POST" action="{{ route('admin.quizzes.store') }}" onsubmit="prepareQuizData()" class="quiz-form">
                        @csrf
                        
                        @if(isset($course))
                        <input type="hidden" name="course_id" value="{{ $course->id }}">
                        @endif
                        <input type="hidden" name="redirect_source" value="{{ request()->query('from', 'edit') }}">
