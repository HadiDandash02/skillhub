...
<div class="job-page">
    ...
    <section class="header-section">
        <div class="header-container">
            ...
            <div class="header-actions">
                <a href="{{ route('admin.jobs') }}" class="btn-secondary-header">
    ...
    <div class="content-wrapper">
        <div class="content-container">
            <form method="POST" action="{{ route('admin.jobs.update', $job->id) }}" class="edit-job-form">
                @csrf
                @method('PATCH')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company" id="company" 
                                           value="{{ old('company', $job->company) }}" class="form-control @error('company') is-invalid @enderror" 
                ...
                <div class="card form-card">
                    ...
                    <div class="submit-group">
                        ...
                        <a href="{{ route('admin.jobs') }}" class="btn-cancel">
