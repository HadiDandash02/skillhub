        ...
        <div class="jobs-content-container">
            ...
            <div class="quick-actions-section">
                <div class="action-card primary-action">
                    ...
                    <a href="{{ route('admin.jobs.create') }}" class="action-button">
            ...
            <div class="table-card">
                                    ...
                                    <tr class="job-row">
                                        ...
                                        <td class="actions-cell">
                                            <div class="action-buttons">
                                                <button type="button" class="btn btn-edit" onclick="window.location.href='{{ route('admin.jobs.edit', $job->id) }}'" title="Edit Job">
                                                    <i class="fas fa-edit"></i>
                                                    <span>Edit</span>
                                                </button>
                                                <form action="{{ route('admin.jobs.delete', $job->id) }}" method="POST" class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
                ...
                <div class="empty-state">
                    ...
                    <a href="{{ route('admin.jobs.create') }}" class="btn-empty-action">
                        <i class="fas fa-plus"></i>
