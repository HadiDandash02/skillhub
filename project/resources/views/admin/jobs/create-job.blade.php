...
<div class="job-page">
    ...
    <div class="content-wrapper">
        <div class="content-container">
            <form method="POST" action="{{ route('admin.jobs.store') }}" class="edit-job-form">
                @csrf
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="company" id="company" 
                                           value="{{ old('company') }}" class="form-control @error('company') is-invalid @enderror" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="location" id="location" 
                                           value="{{ old('location') }}" class="form-control @error('location') is-invalid @enderror" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="salary_range" id="salary_range" 
                                           value="{{ old('salary_range') }}" class="form-control @error('salary_range') is-invalid @enderror" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="deadline" id="deadline" 
                                           value="{{ old('deadline') }}" class="form-control @error('deadline') is-invalid @enderror">
                                    @error('deadline')
                                        <span class="form-error">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            <div class="checkbox-group">
                                <input type="checkbox" name="remote_option" id="remote_option" value="1" 
                                       {{ old('remote_option') ? 'checked' : '' }} class="checkbox-input">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" 
                                      rows="6" required placeholder="Provide a detailed job description">{{ old('description') }}</textarea>
                            @error('description')
                                <span class="form-error">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="requirements" id="requirements" class="form-control @error('requirements') is-invalid @enderror" 
                                      rows="4" placeholder="List the job requirements (one per line)">{{ old('requirements') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="responsibilities" id="responsibilities" class="form-control @error('responsibilities') is-invalid @enderror" 
                                      rows="4" placeholder="List the key responsibilities (one per line)">{{ old('responsibilities') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="skills_required" id="skills_required" 
                                   value="{{ old('skills_required') }}" class="form-control @error('skills_required') is-invalid @enderror" 
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="benefits" id="benefits" class="form-control @error('benefits') is-invalid @enderror" 
                                      rows="4" placeholder="List the benefits and perks (one per line)">{{ old('benefits') }}</textarea>
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="company_description" id="company_description" class="form-control @error('company_description') is-invalid @enderror" 
                                      rows="4" placeholder="Tell candidates about your company...">{{ old('company_description') }}</textarea>
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🎯 Professional Job Creation Form Loaded');
    ...
    console.log('✅ Professional Job Creation Form Ready!');
});
