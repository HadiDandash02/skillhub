...
<section class="advice-header-section">
    <div class="advice-header-container">
        <div class="header-content">
            ...
            <h1 class="header-title">{{ $advice->title }}</h1>
            <div class="header-meta">
                <div class="meta-item">
                    <i class="fas fa-tag"></i>
                    <span>{{ ucfirst($advice->category) }}</span>
                </div>
                <div class="meta-item">
                ...
                <div class="meta-item">
                    ...
                    <span>{{ ceil(str_word_count(strip_tags($advice->content)) / 200) }} min read</span>
                </div>
            </div>
        </div>
    ...
    <div class="article-info">
        <div class="article-tags">
            ...
            <span class="category-tag">
                <i class="fas fa-{{ $advice->category === 'interview' ? 'handshake' : ($advice->category === 'networking' ? 'users' : ($advice->category === 'resume' ? 'file-alt' : 'briefcase')) }}"></i>
        ...
        <div class="article-company">
            ...
            <span class="company-name">
                {{ $advice->careerManager->company_name ?? 'Career Expert' }}
            </span>
        </div>
    </div>
        ...
        <button class="btn-action btn-print" onclick="window.print()">
            ...
            {{-- <div class="navigation-card">
                ...
                <div class="nav-content">
                    <a href="{{ url()->previous() }}" class="nav-link primary">
                        <i class="fas fa-arrow-left"></i>
                        <span>Back to Career Services</span>
                    </a>
                    <a href="{{ route('careerservices') }}" class="nav-link secondary">
                        <i class="fas fa-home"></i>
                        <span>Career Services Home</span>
                    </a>
                </div>
            </div> --}}
