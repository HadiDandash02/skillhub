...
<div class="job-page">
    ...
    <section class="header-section">
        <div class="header-container">
            <div class="header-content">
                ...
                <h1 class="header-title">Edit Job Listing</h1>
                <p class="header-description">Update and refine your job opportunity details</p>
            </div>
            <div class="header-actions">
                <a href="{{ route('careerM.jobs') }}" class="btn-secondary-header">
    ...
    <div class="content-wrapper">
        <div class="content-container">
            <form method="POST" action="{{ route('careerM.jobs.update', $job->id) }}" class="edit-job-form">
                @csrf
                @method('PATCH')
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="title" id="title" value="{{ old('title', $job->title) }}" 
                                   class="form-control @error('title') is-invalid @enderror" required placeholder="e.g. Senior Frontend Developer">
                            @error('title')
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="location" id="location" 
                                           value="{{ old('location', $job->location) }}" class="form-control @error('location') is-invalid @enderror" 
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="employment_type" id="employment_type" class="form-control employment-dropdown @error('employment_type') is-invalid @enderror" required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="experience_level" id="experience_level" class="form-control experience-dropdown @error('experience_level') is-invalid @enderror">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="salary_range" id="salary_range" 
                                           value="{{ old('salary_range', $job->salary_range) }}" class="form-control @error('salary_range') is-invalid @enderror" 
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" name="deadline" id="deadline" 
                                           value="{{ old('deadline', $job->deadline ? $job->deadline->format('Y-m-d') : '') }}" class="form-control @error('deadline') is-invalid @enderror">
                                    @error('deadline')
                                        <span class="form-error">{{ $message }}</span>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group">
                            <div class="checkbox-group">
                                <input type="checkbox" name="remote_option" id="remote_option" value="1" 
                                       {{ old('remote_option', $job->remote_option) ? 'checked' : '' }} class="checkbox-input">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" 
                                      rows="6" required placeholder="Provide a detailed job description">{{ old('description', $job->description) }}</textarea>
                            @error('description')
                                <span class="form-error">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="requirements" id="requirements" class="form-control @error('requirements') is-invalid @enderror" 
                                      rows="4" placeholder="List the job requirements (one per line)">{{ old('requirements', $job->requirements) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="responsibilities" id="responsibilities" class="form-control @error('responsibilities') is-invalid @enderror" 
                                      rows="4" placeholder="List the key responsibilities (one per line)">{{ old('responsibilities', $job->responsibilities) }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="benefits" id="benefits" class="form-control @error('benefits') is-invalid @enderror" 
                                      rows="4" placeholder="List the benefits and perks (one per line)">{{ old('benefits', $job->benefits) }}</textarea>
                ...
                <div class="card form-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="company_description" id="company_description" class="form-control @error('company_description') is-invalid @enderror" 
                                      rows="4" placeholder="Tell candidates about your company...">{{ old('company_description', $job->company_description) }}</textarea>
                    ...
                    <div class="submit-group">
                        ...
                        <a href="{{ route('careerM.jobs') }}" class="btn-cancel">
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('🎯 Professional Career Manager Job Edit Form Loaded');
    ...
    console.log('✅ Professional Career Manager Job Edit Form Ready!');
});
...
{{-- <script>
    // Enhanced company field handling
document.addEventListener('DOMContentLoaded', function() {
    const companyInput = document.getElementById('company');
    
    if (companyInput && companyInput.hasAttribute('readonly')) {
        // Add visual styling for readonly company field
        companyInput.style.backgroundColor = '#f8fafc';
        companyInput.style.borderColor = '#e2e8f0';
        companyInput.style.cursor = 'not-allowed';
        
        // Add a tooltip or help text
        const helpText = document.createElement('small');
        helpText.className = 'form-help readonly-help';
        helpText.innerHTML = '<i class="fas fa-lock"></i> This field is automatically filled with your company name';
        helpText.style.color = '#64748b';
        helpText.style.fontStyle = 'italic';
        helpText.style.marginTop = '0.25rem';
        helpText.style.display = 'block';
        
        // Insert help text after the company input
        companyInput.parentNode.insertBefore(helpText, companyInput.nextSibling);
        
        // Add a subtle icon to indicate it's locked
        const lockIcon = document.createElement('i');
        lockIcon.className = 'fas fa-lock company-lock-icon';
        ...
        companyInput.parentNode.appendChild(lockIcon);
        
        // Adjust padding to make room for the icon
        companyInput.style.paddingRight = '2.5rem';
    }
});
</script> --}}
<!-- FontAwesome -->
