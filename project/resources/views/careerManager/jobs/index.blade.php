        ...
        <div class="jobs-header-container">
            <div class="header-content">
                ...
                <div class="header-stats">
                    <div class="stat-item">
                        <i class="fas fa-briefcase"></i>
                        <span id="totalJobsCount">{{ count($jobs) }} Active Jobs</span>
                    </div>
                    <div class="stat-item">
        ...
        <div class="jobs-content-container">
            ...
            <div class="quick-actions-section">
                <div class="action-card primary-action">
                    ...
                    <a href="{{ route('careerM.jobs.create') }}" class="action-button">
            ...
            <div class="management-controls">
                ...
                <div class="filter-section">
                    <form method="GET" action="{{ route('careerM.jobs') }}" class="filter-form">
            ...
            <div class="table-card">
                    ...
                    <div class="table-actions">
                        <div class="job-stats">
                            ...
                            <div class="stat-badge">
                                ...
                                <span id="companiesCount">{{ $totalCompanies }} Companies</span>
                            </div>
                            <div class="stat-badge">
                                <i class="fas fa-map-marker-alt"></i>
                                <span id="locationsCount">{{ $totalLocations }} Locations</span>
                            </div>
                            <div class="stat-badge">
                                <i class="fas fa-eye"></i>
                                <span id="visibleJobsCount">{{ count($jobs) }} Jobs Shown</span>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tr class="job-row">
                                            ...
                                            <div class="job-info">
                                                ...
                                                <div class="job-details">
                                                    ...
                                                    <p class="job-description">
                                                        ...
                                                        {{ Str::limit($job->description ?? 'No description available', 50) }}
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="actions-cell">
                                            <div class="action-buttons">
                                                <button type="button" class="btn btn-edit" onclick="window.location.href='{{ route('careerM.jobs.edit', $job->id) }}'" title="Edit Job">
                                                    <i class="fas fa-edit"></i>
                                                    <span>Edit</span>
                                                </button>
                                                <form action="{{ route('careerM.jobs.delete', $job->id) }}" method="POST" class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
                ...
                <div class="empty-state">
                    ...
                    <a href="{{ route('careerM.jobs.create') }}" class="btn-empty-action">
                        <i class="fas fa-plus"></i>
