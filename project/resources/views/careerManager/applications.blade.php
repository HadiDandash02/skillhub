                            ...
                            <tr class="application-row" data-status="{{ strtolower($application->status) }}">
                                ...
                                <td class="actions-cell">
                                    <div class="action-buttons">
                                        <!-- View Details Button -->
                                        <button class="view-details-btn" onclick="viewApplicationDetails({{ $application->id }})" title="View Application Details">
                                            <i class="fas fa-eye"></i>
                                            <span>View Details</span>
                                        </button>
                                        
                                        <!-- Status Update Form -->
                                        <form action="{{ route('careerM.applications.update', $application->id) }}" method="POST" class="status-form">
                                            @csrf
                                            @method('PATCH')
