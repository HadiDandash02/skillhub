        ...
        <div class="advice-header-container">
            <div class="header-content">
                ...
                <div class="header-stats">
                    <div class="stat-item">
                        <i class="fas fa-lightbulb"></i>
                        <span>{{ count($advices) }} Total Articles</span>
                    </div>
                    <div class="stat-item">
        ...
        <div class="advice-content-container">
            ...
            <div class="management-controls">
                ...
                <div class="quick-actions-section">
                    <div class="action-card primary-action">
                        ...
                        <a href="{{ route('careerM.career-advice.create') }}" class="action-button">
            ...
            <div class="table-card">
                                    ...
                                    <tr class="advice-row">
                                            ...
                                            <div class="advice-info">
                                                ...
                                                <div class="advice-details">
                                                    ...
                                                    <p class="advice-meta">
                                                        ...
                                                        {{ $advice->author ?? 'System Career Manager' }}
                                                    </p>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td class="actions-cell">
                                            <div class="action-buttons">
                                                <a href="{{ route('careerM.career-advice.edit', $advice->id) }}" class="btn btn-edit" title="Edit Advice">
                                                ...
                                                <form action="{{ route('careerM.career-advice.destroy', $advice->id) }}" method="POST" class="delete-form">
                                                    @csrf
                                                    @method('DELETE')
                ...
                <div class="empty-state">
                    ...
                    <a href="{{ route('careerM.career-advice.create') }}" class="btn-empty-action">
                        <i class="fas fa-plus"></i>
